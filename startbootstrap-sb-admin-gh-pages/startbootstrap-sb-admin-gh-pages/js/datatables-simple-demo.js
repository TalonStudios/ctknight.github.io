window.addEventListener('DOMContentLoaded', event => {
    ...
    let randomnum = Math.floor(Math.random() * tableData.length);
    const randomRow = tableData[randomnum];
    document.getElementById("successfuldude").textContent = 
    `${randomRow.name}, ${randomRow.position}`;
});
